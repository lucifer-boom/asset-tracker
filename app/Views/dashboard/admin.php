...
<head>
    ...
    <title>Admin Dashboard | CA Asset Management</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Assets Information:</h6>
                        <a class="collapse-item" href="">Computers</a>
                        <a class="collapse-item" href="">Network Devices</a>
